...
public final class OverscrollHelper {
	 ...
	 */
	public static void overScrollBy(final com.example.refreshlistview.PullToRefreshBase<?> view, final int deltaX, final int scrollX,
	...
	public static void overScrollBy(final com.example.refreshlistview.PullToRefreshBase<?> view, final int deltaX, final int scrollX,
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			final com.example.refreshlistview.PullToRefreshBase.Mode mode = view.getMode();
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (com.example.refreshlistview.PullToRefreshBase.DEBUG) {
				...
				if (newScrollValue < (0 - fuzzyThreshold)) {
					...
					if (mode.showHeaderLoadingLayout()) {
						...
						if (currentScrollValue == 0) {
							view.setState(com.example.refreshlistview.PullToRefreshBase.State.OVERSCROLLING);
						}
					...
					view.setState(com.example.refreshlistview.PullToRefreshBase.State.RESET);
				}
			} else if (isTouchEvent && com.example.refreshlistview.PullToRefreshBase.State.OVERSCROLLING == view.getState()) {
