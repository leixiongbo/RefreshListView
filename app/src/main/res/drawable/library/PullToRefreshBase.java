...
import com.example.refreshlistview.ILoadingLayout;
import com.example.refreshlistview.IPullToRefresh;
import com.example.refreshlistview.LoadingLayoutProxy;
import com.example.refreshlistview.OverscrollHelper;
import com.example.refreshlistview.PullToRefreshAdapterViewBase;

import cn.tianqu.coach1.R;
import com.example.refreshlistview.internal.FlipLoadingLayout;
import com.example.refreshlistview.internal.LoadingLayout;
import com.example.refreshlistview.internal.RotateLoadingLayout;
import com.example.refreshlistview.internal.Utils;
import com.example.refreshlistview.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	@Override
	public final com.example.refreshlistview.ILoadingLayout getLoadingLayoutProxy() {
...
//		}
	 ...
	 */
	protected com.example.refreshlistview.LoadingLayoutProxy createLoadingLayoutProxy(
			final boolean includeStart, final boolean includeEnd) {
		com.example.refreshlistview.LoadingLayoutProxy proxy = new LoadingLayoutProxy();
	...
	public static enum Mode {
		 ...
		 * {@link com.example.refreshlistview.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	 ...
	 * {@link com.example.refreshlistview.PullToRefreshAdapterViewBase#setOnLastItemVisibleListener}.
	 *
	 * @author Chris Banes
	 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 */
		public void onPullEvent(final com.example.refreshlistview.PullToRefreshBase<V> refreshView,
	...
	public static interface OnRefreshListener<V extends View> {
		 ...
		 * end
		 */
		public void onRefresh(final com.example.refreshlistview.PullToRefreshBase<V> refreshView);
	...
	public static interface OnRefreshListener2<V extends View> {
		 ...
		 */
		public void onPullDownToRefresh(final com.example.refreshlistview.PullToRefreshBase<V> refreshView);

		/**
		 * onPullUpToRefresh will be called only when the user has Pulled from
		 * the end, and released.
		 */
		public void onPullUpToRefresh(final com.example.refreshlistview.PullToRefreshBase<V> refreshView);
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mContinueRunning && mScrollToY != mCurrentY) {
				ViewCompat.postOnAnimation(com.example.refreshlistview.PullToRefreshBase.this, this);
			} else {
				if (null != mListener) {
