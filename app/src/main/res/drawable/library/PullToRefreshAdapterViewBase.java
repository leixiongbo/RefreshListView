...
import com.example.refreshlistview.PullToRefreshBase;

import cn.tianqu.coach1.R;
import com.example.refreshlistview.internal.EmptyViewMethodAccessor;
import com.example.refreshlistview.internal.IndicatorLayout;


public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends com.example.refreshlistview.PullToRefreshBase<T> implements
        OnScrollListener {
	 ...
	 * {@link com.example.refreshlistview.PullToRefreshBase#isPullToRefreshOverScrollEnabled()
	...
	/**
	 * Pass-through method for {@link com.example.refreshlistview.PullToRefreshBase#getRefreshableView()
	 * getRefreshableView()}.
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			params.rightMargin = getResources().getDimensionPixelSize(R.dimen.pull_indicator_right_padding);
